                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="fullName"
                        id="fullName"
                        placeholder="Michel Papin"
                        defaultValue="Michel Papin"
                      />
                    </div>
                  </div>
                  ...
                  <div className="w-full sm:w-1/2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        name="phoneNumber"
                        id="phoneNumber"
                        placeholder="06 10 33 43 65"
                        defaultValue="06 10 33 43 65"
                      />
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="emailAddress"
                      id="emailAddress"
                      placeholder="michelpapin45@gmail.com"
                      defaultValue="michelpapin45@gmail.com"
                    />
                  </div>
                </div>
                ...
                <div className="mb-5.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      name="Username"
                      id="Username"
                      placeholder="michelpapin24"
                      defaultValue="michelpapin24"
                    />
                  </div>
                </div>
